...
class WandbCallback(BaseCallback):
    ...
    def on_initialisation_end(self, trainer=None):
        ...
        if not trainer.experiment_path.exists():
            trainer.experiment_path.mkdir(parents=True, exist_ok=False)
        else:
            print(f"[SaveBestModelCallback] Reusing existing directory: {trainer.experiment_path}")
